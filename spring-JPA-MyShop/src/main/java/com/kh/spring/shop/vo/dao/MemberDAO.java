package com.kh.spring.shop.vo.dao;
...
Repository
	스프링에서 주로 사용.
	데이터를 엑세스하기 위한 기능은 Bean을 통해 제공.
	스프링에 제공하는 기능을 활요해서 데이터 엑세스를 편리하게 처리할 수 있음.
...
JPA
	admin(관리자) : 고객 검색
		관리자 아이디/관리자 비밀번호
	customer(고객) : 가입하고 상세보기에서 자신의 정보를 볼 수 있음. 탈퇴할 수 있음.
*/
